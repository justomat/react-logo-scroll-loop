	...
	return React.createElement(
		'div',
		{
			style: style(
				...
				undefined,
				undefined,
				'0 10px 20px -5px rgba(0, 0, 0, 0.125)',
				undefined,
				undefined,
				undefined,
				undefined,
		...
		React.createElement(
			'div',
			{
				style: style(
					...
					undefined,
					undefined,
					'scroll ' + String(duration) + 's linear infinite',
					undefined,
					undefined,
					undefined,
					undefined,
			...
			Belt_Array.map(
				Belt_Array.reduce(
					Belt_Array.map([children, children], function (prim) {
...
export { style, Gradient$1 as Gradient, make$1 as make, $$Image };
/*  Not a pure module */
